...
EOF
```
![Create Inventory](./Images/10.png)
...
cat inventory.ini
```
![Verify Inevntory](./Images/11.png)
...
```
![Create Playbook](./Images/14.png)

**Step-16:- Run Playbook**
```bash
ansible-playbook -i inventory.ini playbook1.yml
```
![Run Playbook](./Images/15.png)
