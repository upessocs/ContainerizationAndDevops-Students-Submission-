...
@app.route("/")
def home():
    return "Hello from CI/CD Pipeline!, my sapid is 500121982"
...
![Install Plugins](./Images/.png)

---

**Step 10: Plugins List**

![Plugins List](./Images/9.png)

---

**Step 11: Create Admin User**

![Create Admin User](./Images/10.png)
...
**Step 14: Repository will be listed**

![Repo List](./Images/14.png)
...
**Step 16: Build Status Success will be shown with Green Tick**
